    ...
    class MyEmailServer implements EmailServerInterface {
        public function sendEmail($email, $name, $message) { //$email, $name, $message.. $to, $subject, $message
            ...
            try {
                ...
                $mail->Username   = 'dongphuongthi2809@gmail.com';                     //SMTP username
                $mail->Password   = 'jocphegqvaqroisq';                               //SMTP password
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
            
                //Recipients
                $mail->setFrom('from@example.com', 'Mailer');
                $mail->addAddress('tojimomirudo54@gmail.com', 'DP');     //Add a recipient
